...
class RecipeViewModel {
    ...
    // Expose session.isResponding so the UI can disable the Ask button
    ...
    private func setupSession() {
        ...
        case .available:
            ...
            // Prewarm loads the model in the background so the first
            // response feels fast rather than loading cold.
